...
public class BankNote {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        File fileTrain = new ClassPathResource("data_banknote_authentication_train.csv").getFile();
        ...
        File fileTest = new ClassPathResource("data_banknote_authentication_test.csv").getFile();
        ...
        ModelSerializer.writeModel(model,"banknote_Authentication.zip",true);
